# FAH: Taken from <common>\3rdparty_python\training\optimizer\AdaBelief\21.7.0\AdaBelief\pypi_packages\adabelief_pytorch0.2.1\adabelief_pytorch
# So this seems to be the code for the AdaBelief pip package, version 0.2.1
# Note it has some changed default parameters (e.g. eps) compared with the paper at https://arxiv.org/abs/2010.07468
# Note I changed the default variables for some variables to more reasonable ones.
# Specifically, i changed default value for 'eps' to '1e-8', and turned off 'rectify' and 'degenerated_to_sgd' per default.
...
class AdaBelief(Optimizer):
    ...
    Arguments:
        ...
        eps (float, optional): term added to the denominator to improve
            numerical stability (default: 1e-8) (FAH: changed default from 1e-16 to 1e-8)
        ...
        rectify (boolean, optional): (default: False) If set as True, then perform the rectified
            update similar to RAdam  (FAH: changed default to 'False')
        degenerated_to_sgd (boolean, optional) (default:True) If set as True, then perform SGD update
            when variance of gradient is high (FAH: changed default to 'False')
